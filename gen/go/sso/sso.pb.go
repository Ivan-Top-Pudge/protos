...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x13IsUserExistsRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\".\n" +
	"\x14IsUserExistsResponse\x12\x16\n" +
	"\x06exists\x18\x01 \x01(\bR\x06exists2\xf2\x01\n" +
	"\x04Auth\x129\n" +
	...
	"\fIsUserExists\x12\x19.auth.IsUserExistsRequest\x1a\x1a.auth.IsUserExistsResponseB\x13Z\x11vano.sso.v1;ssov1b\x06proto3"
